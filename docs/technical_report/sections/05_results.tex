...
relative NLL differences $100(L_{\mathrm{route}}-L_{\mathrm{BF16}})/L_{\mathrm{BF16}}$
...
The 27/5 depth hybrid contributes one terminal exact checkpoint, at step
38,000. Its validation NLL is 2.538116, or 4.440\% higher than matched BF16.
No earlier exact checkpoint is available for this route, so we report the one
measured point without constructing an intermediate curve.
...
\begin{figure}[tbp]
  ...
  extrapolated. The 27/5 depth hybrid contributes only its terminal step-38,000
  marker.}
