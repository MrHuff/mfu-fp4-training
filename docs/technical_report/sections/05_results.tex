...
\begin{figure}[tbp]
  ...
  plotted endpoint. Sparse pure-v5 telemetry after step 19,000 is shown as
  exact anchors with a robust locally weighted scatterplot smoothing (LOWESS)
  display fit. The fit is not used for endpoint values or comparisons. The
  27/5 depth-hybrid line stops at its last continuous observation at step
  35,530; its open diamond is the separate exact step-38,140 endpoint. The
  blank interval contains no recovered telemetry.}
