...
reported loss value is interpolated. The dashed late-v5 line is the
...
\begin{figure}[tbp]
  ...
  plotted endpoint. Pure-v5 telemetry is dense through step 19,000. After that
  point, the upper panel marks 74 exact recovered r5 observations, including
...
\begin{figure}[tbp]
  ...
  interpolation. As in Figure~\ref{fig:llama8b-loss}, the late-v5 markers are
  exact r5 observations and the dashed curve is their display-only dense-grid
  LOWESS fit.}
