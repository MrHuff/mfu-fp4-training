...
\begin{figure}[tbp]
  ...
  (LOWESS) fit. The 27/5 depth hybrid is a checkpoint-aware stitch of three
  complete logged segments, with no interpolated values.}
...
\begin{figure}[tbp]
  ...
  \caption{Training loss from 120B to 160B tokens. Curves use exact logged
  observations and diamonds mark their final logged endpoints.}
