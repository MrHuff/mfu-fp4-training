...
The system specializes the four repeated boundaries in
...
The arithmetic remains unchanged. Fusion removes intermediate traffic and
exposes independent work to the scheduler. The scale stage is nevertheless
