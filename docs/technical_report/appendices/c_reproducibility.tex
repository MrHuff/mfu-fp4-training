...
is dense through step 19,000. Seventy-four exact r5 observations survive after
that point; the largest telemetry gap spans steps 24,700--33,010. The dashed
late line is a visual LOWESS fit through those observations, evaluated on the
common BF16 display grid. It is never used to compute a reported numeric
