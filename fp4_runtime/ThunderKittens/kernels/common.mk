...
PYTORCH_LIBRARY_PATHS ?= $(shell python3 -c "from torch.utils.cpp_extension import library_paths; print(' '.join(library_paths()))") # recommended: define as an environment variable in advance
