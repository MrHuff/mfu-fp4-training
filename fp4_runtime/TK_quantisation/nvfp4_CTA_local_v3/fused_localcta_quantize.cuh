    ...
    while (true) {
        ...
        if (leading) {
            if (split_id == 0) {
                ...
                row_sg_chunks1[ctaid_Y * split1_tiles + local_ctaid_X] = sg_val;
                col_sg_chunks1[local_ctaid_X * tiles_Y + ctaid_Y] = sg_val;
            } else {
                row_sg_chunks2[ctaid_Y * split2_tiles + local_ctaid_X] = sg_val;
                col_sg_chunks2[local_ctaid_X * tiles_Y + ctaid_Y] = sg_val;
            }
        }
