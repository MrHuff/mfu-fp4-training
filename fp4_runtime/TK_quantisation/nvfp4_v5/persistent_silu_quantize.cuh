...
// ═══════════════════════════════════════════════════════════════════
// Phase-2-only split SiLU quantize: accepts pre-computed amax, reads h1_raw
// and h3 directly, computes silu(h1_raw)*h3, then quantizes and stores.
// No Phase 1 scan and no grid barrier.
// ═══════════════════════════════════════════════════════════════════

struct SiluPhase2Args {
...
template <bool RETURN_TRANSPOSE>
__global__ void __launch_bounds__(V3_THREADS)
persistent_silu_quantize_phase2_kernel(
