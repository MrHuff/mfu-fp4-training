...
if __name__ == "__main__":
    ...
    plt.savefig("EXMY_quantisaiton_func.png", bbox_inches="tight", dpi=300)
    plt.clf()
    ...
    plt.savefig("EXMY_divergence_func.png", bbox_inches="tight", dpi=300)
    plt.clf()
...
plt.step(
    x_continuous_e8m0, y_quantized_e8m0, where="post", label="Quantization Function Q(x)"
)
...
plt.plot(
    ...
    x_continuous_e8m0,
    "r--",
    label="Identity Function (No Quantization)",
    alpha=0.7,
)
plt.scatter(
    e8m0_quantization_levels,
    e8m0_quantization_levels,
    color="green",
    zorder=5,
    s=40,
    label="E8M0 Quantization Levels",
)
...
plt.tight_layout()
plt.savefig("e8m0_scaling_improved.png", bbox_inches="tight", dpi=300)
...
plt.step(
    x_continuous_e4m3, y_quantized_e4m3, where="post", label="Quantization Function Q(x)"
)
...
plt.scatter(
    e4m3_quantization_levels,
    e4m3_quantization_levels,
    color="green",
    zorder=5,
    s=40,
    label="E4M3 Quantization Levels",
)
...
# --- Improvement: Tighten layout and save with high DPI ---
plt.tight_layout()
plt.savefig("e4m3_scaling_improved.png", bbox_inches="tight", dpi=300)
plt.clf()
