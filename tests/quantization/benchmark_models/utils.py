...
class BF16LossScaler:
    def __init__(self, init_scale=2**10, growth_factor=2.0, backoff_factor=0.5, growth_interval=2000):
    ...
    def step(self, optimizer):
        if self._found_inf:
            ...
            print(f"[LossScaler] Found inf/nan in gradients. Skipping step. Reducing scale from {self.scale}.")
