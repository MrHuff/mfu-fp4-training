...
if __name__ == "__main__":
    ...
    file_counter = 0
    for block_size, scale_type, ma, step_gradient,sq,sr_mode,hada_mode,optimiser,ds in itertools.product(BLOCK_SIZES, SCALE_TYPES, MAX_APPROX, STEP_GRADIENTS,SCALING_QUANT_GRADIENTS,SR,HADAMARD,OPTIMISER_STATEMENT,DATASETS):
        a_list = [1.0]
